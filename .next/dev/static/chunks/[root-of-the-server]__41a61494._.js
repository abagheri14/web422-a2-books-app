...
function Register() {
    ...
    const [password2, setPassword2] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const handleSubmit = async (e)=>{
        ...
        const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authenticate$2e$js__$5b$client$5d$__$28$ecmascript$29$__["registerUser"])(user, password, password2);
        if (success) {
            router.push("/login");
        } else {
...
_s(Register, "CKnCGHHSqZyK61ZYQCuPWWyM+t4=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__41a61494._.js.map